...
<body>
<section class="kemitraanDetail__section container">
    <div class="kemitraanDetail grid">
        <div class="kemitraanDetail__left">
            <img class="kemitraan-img" src="../../asset/mitra/usaha.jpg" alt="">
        </div>
        <div class="kemitraanDetail__right">
            ...
            <button class="kemitraanDetail__button" onclick="location.href='mitra_kemitraan.php'">
            AJUKAN KERJASAMA
            </button>
        </div>
    </div>
